...
public interface TradeService {
	...
	Trade process(TradeReceiveCommand command) throws SerializeException;
	Trade process(TradeSearchCfinCommand command) throws TradeNotFoundException, SerializeException, ClassNotFoundException, InstantiationException, IllegalAccessException;
}
